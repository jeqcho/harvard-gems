...
@Component({
  selector: 'app-spring2023',
  templateUrl: './spring2023.component.html',
  styleUrls: ['./spring2023.component.scss']
})
export class Spring2023Component {
  dropDownList: any;
  ...
  BigString = String
  url_prefix = 'https://portal.my.harvard.edu/psp/hrvihprd/EMPLOYEE/EMPL/h/?tab=HU_CLASS_SEARCH&SearchReqJSON=%7B%22ExcludeBracketed%22%3Atrue%2C%22SaveRecent%22%3Atrue%2C%22Facets%22%3A%5B%5D%2C%22PageNumber%22%3A1%2C%22SortOrder%22%3A%5B%22SCORE%22%5D%2C%22TopN%22%3A%22%22%2C%22PageSize%22%3A%22%22%2C%22SearchText%22%3A%22(STRM%3A%5C%222232%5C%22)';
  url_suffix = '%22%7D'
  ...
  ngOnInit(): void {
    ...
    for (let department of department_list) {
      this.getDataHttp(`assets/data/spring2023/departments/${department}.json`).subscribe(
        (data: any) => {
